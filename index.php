...
<html data-ng-app="myApp" lang="hr">
	...
	<link href="css/datepicker.css" rel="stylesheet">
        ...
        <script>
            userLocate();
            addParking(45.798785, 15.971095, 'Najbolje Parkiraliste', 'hahahah');
            addParking(45.800785, 15.975095, 'Parkiraliste bez mijesta za invalide', 'Nemate noge, ruke, glavu. Well tough luck, nemate sto traziti na ovome parkiralistu.');
                          ...
                          <form role="form" id="footer-form2" name="registerForm" novalidate>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <script type = "text/javascript">
                                        ...
                                        <input type = "text" id = "datepicker" class="form-control" placeholder="Datum rođenja" name="datepicker" data-ng-model="datepicker" required/>
                                    <i class="fa fa-calendar form-control-feedback"></i>
                                </div>
                                <div class="alert alert-danger" data-ng-show="submitted && registerForm.date.$error.required">Datum rođenja je potreban!</div>
                                <div class="form-group has-feedback" >
